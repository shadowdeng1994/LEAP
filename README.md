...
**L**UG-encoded **E**ncestral **A**ncestral **P**rojection — a phylogeny-based computational framework for inferring the transcriptional states of unobserved internal nodes from cell phylogenies via lineage-specific upregulated genes (LUGs).
